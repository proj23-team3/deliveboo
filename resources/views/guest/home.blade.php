        ...
        <nav class="navbar navbar-expand-lg bg-primary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">
                    <img src="{{ asset('img/logo_white.png') }}" alt="" height="32">
                </a>
                <button
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1 bg-light"><a
                                class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Collabora
                                con noi</a></li>
                        <li class="nav-item mx-0 mx-lg-1 bg-light"><a
                                class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about">0,00 €</a>
                        </li>
                        <li class="nav-item mx-0 mx-lg-1 bg-light"><a
                                class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#contact">Menu</a>
                        </li>
                    </ul>
                </div>
            </div>
